...
namespace Nop.Web.Areas.Admin.Validators.Tax
{
    ...
    {
        public TaxCategoryValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<TaxCategory, MerchantDB>(dataProvider);
        }
    }
}
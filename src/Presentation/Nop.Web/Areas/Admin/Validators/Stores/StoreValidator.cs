...
namespace Nop.Web.Areas.Admin.Validators.Stores
{
    ...
    {
        public StoreValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<Store, MerchantDB>(dataProvider);
        }
    }
}
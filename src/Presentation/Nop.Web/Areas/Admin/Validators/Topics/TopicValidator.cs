...
namespace Nop.Web.Areas.Admin.Validators.Topics
{
    ...
    {
        public TopicValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            RuleFor(x => x.SeName)
            ...
            SetDatabaseValidationRules<Topic, MerchantDB>(dataProvider);
        }
    }
}

...
namespace Nop.Web.Areas.Admin.Validators.Orders
{
    ...
    {
        public ReturnRequestActionValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ReturnRequestAction, MerchantDB>(dataProvider);
        }
    }
}
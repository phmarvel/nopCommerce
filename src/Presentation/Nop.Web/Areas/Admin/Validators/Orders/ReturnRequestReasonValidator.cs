...
namespace Nop.Web.Areas.Admin.Validators.Orders
{
    ...
    {
        public ReturnRequestReasonValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ReturnRequestReason, MerchantDB>(dataProvider);
        }
    }
}
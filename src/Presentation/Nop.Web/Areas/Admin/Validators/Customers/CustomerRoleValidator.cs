...
namespace Nop.Web.Areas.Admin.Validators.Customers
{
    ...
    {
        public CustomerRoleValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<CustomerRole, MerchantDB>(dataProvider);
        }
    }
}
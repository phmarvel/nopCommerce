...
namespace Nop.Web.Areas.Admin.Validators.Customers
{
    ...
    {
        public CustomerAttributeValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<CustomerAttribute, MerchantDB>(dataProvider);
        }
    }
}
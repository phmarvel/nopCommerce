...
namespace Nop.Web.Areas.Admin.Validators.Customers
{
    ...
    {
        public CustomerAttributeValueValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<CustomerAttributeValue, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.News
{
    ...
    {
        public NewsItemValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<NewsItem, MerchantDB>(dataProvider);
        }
    }
}
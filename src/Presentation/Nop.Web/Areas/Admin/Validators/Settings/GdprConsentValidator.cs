...
namespace Nop.Web.Areas.Admin.Validators.Settings
{
    ...
    {
        public GdprConsentValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<GdprConsent, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Localization
{
    ...
    {
        public LanguageResourceValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            RuleSet(NopValidationDefaults.ValidationRuleSet, () =>
            {
                ...
                SetDatabaseValidationRules<LocaleStringResource, MerchantDB>(dataProvider);
            });
        }
    }
}
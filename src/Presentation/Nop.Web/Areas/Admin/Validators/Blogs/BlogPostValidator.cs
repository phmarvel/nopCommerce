...
namespace Nop.Web.Areas.Admin.Validators.Blogs
{
    ...
    {
        public BlogPostValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            RuleFor(x => x.Title)
                .NotEmpty()
            ...
            SetDatabaseValidationRules<BlogPost,MerchantDB> (dataProvider);
        }
    }
}
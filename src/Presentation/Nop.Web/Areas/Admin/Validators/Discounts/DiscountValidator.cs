...
namespace Nop.Web.Areas.Admin.Validators.Discounts
{
    ...
    {
        public DiscountValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<Discount, MerchantDB>(dataProvider);
        }
    }
}
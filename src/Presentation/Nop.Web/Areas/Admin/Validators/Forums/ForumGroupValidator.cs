...
namespace Nop.Web.Areas.Admin.Validators.Forums
{
    ...
    {
        public ForumGroupValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ForumGroup, MerchantDB>(dataProvider);
        }
    }
}
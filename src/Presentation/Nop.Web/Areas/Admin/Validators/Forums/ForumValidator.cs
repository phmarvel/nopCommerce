...
namespace Nop.Web.Areas.Admin.Validators.Forums
{
    ...
    {
        public ForumValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<Forum, MerchantDB>(dataProvider);
        }
    }
}
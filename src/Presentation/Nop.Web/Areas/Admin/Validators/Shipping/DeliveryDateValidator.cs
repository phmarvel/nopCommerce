...
namespace Nop.Web.Areas.Admin.Validators.Shipping
{
    ...
    {
        public DeliveryDateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<DeliveryDate, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Shipping
{
    ...
    {
        public WarehouseValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<Warehouse, MerchantDB>(dataProvider);
        }
    }
}
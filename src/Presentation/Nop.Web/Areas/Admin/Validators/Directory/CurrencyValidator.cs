...
namespace Nop.Web.Areas.Admin.Validators.Directory
{
    ...
    {
        public CurrencyValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            RuleFor(x => x.Name)
            ...
            SetDatabaseValidationRules<Currency, MerchantDB>(dataProvider);
        }
    }
}
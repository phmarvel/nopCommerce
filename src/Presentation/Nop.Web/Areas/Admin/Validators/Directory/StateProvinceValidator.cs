...
namespace Nop.Web.Areas.Admin.Validators.Directory
{
    ...
    {
        public StateProvinceValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<StateProvince, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Directory
{
    ...
    {
        public MeasureWeightValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<MeasureWeight, MerchantDB>(dataProvider);
        }
    }
}
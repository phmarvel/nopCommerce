...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public ProductTemplateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ProductTemplate, MerchantDB>(dataProvider);
        }
    }
}
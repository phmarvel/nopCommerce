...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public TopicTemplateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<TopicTemplate, MerchantDB>(dataProvider);
        }
    }
}
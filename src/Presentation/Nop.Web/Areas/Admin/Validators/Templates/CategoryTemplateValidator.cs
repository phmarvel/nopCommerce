...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public CategoryTemplateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<CategoryTemplate, MerchantDB>(dataProvider);
        }
    }
}
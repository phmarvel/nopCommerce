...
namespace Nop.Web.Areas.Admin.Validators.Templates
{
    ...
    {
        public ManufacturerTemplateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ManufacturerTemplate, MerchantDB>(dataProvider);
        }
    }
}
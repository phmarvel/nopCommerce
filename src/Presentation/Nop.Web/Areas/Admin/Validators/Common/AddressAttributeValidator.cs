...
namespace Nop.Web.Areas.Admin.Validators.Common
{
    ...
    {
        public AddressAttributeValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<AddressAttribute, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Messages
{
    ...
    {
        public QueuedEmailValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<QueuedEmail, MerchantDB>(dataProvider);

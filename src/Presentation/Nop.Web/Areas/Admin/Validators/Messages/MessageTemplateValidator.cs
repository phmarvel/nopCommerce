...
namespace Nop.Web.Areas.Admin.Validators.Messages
{
    ...
    {
        public MessageTemplateValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<MessageTemplate, MerchantDB>(dataProvider);
        }
    }
}
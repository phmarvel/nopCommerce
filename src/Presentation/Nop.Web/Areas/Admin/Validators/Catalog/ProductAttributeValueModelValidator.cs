...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ProductAttributeValueModelValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
            ...
            SetDatabaseValidationRules<ProductAttributeValue, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public SpecificationAttributeOptionValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<SpecificationAttributeOption, MerchantDB>(dataProvider);
        }
    }
}
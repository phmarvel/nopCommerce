...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public CategoryValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<Category, MerchantDB>(dataProvider);
        }
    }
}
...
namespace Nop.Web.Areas.Admin.Validators.Catalog
{
    ...
    {
        public ProductTagValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<ProductTag, MerchantDB>(dataProvider);
        }
    }
}
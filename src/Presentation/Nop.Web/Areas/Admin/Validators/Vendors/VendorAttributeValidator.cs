...
namespace Nop.Web.Areas.Admin.Validators.Vendors
{
    ...
    {
        public VendorAttributeValidator(ILocalizationService localizationService, INopDataProvider<MerchantDB> dataProvider)
        {
            ...
            SetDatabaseValidationRules<VendorAttribute, MerchantDB>(dataProvider);
        }
    }
}